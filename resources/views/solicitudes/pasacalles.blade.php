<x-layouts.app>
    ...
    <form action="{{ route('solicitudes.store') }}" enctype="multipart/form-data" method="POST">
        ...
        <h6 class="h6-tipografia-govco" style="font-size:13px;  padding-left:9.5%"> La solicitud solo puede ser realizada
        ...
        <div class="row" style="padding-left:9.5%">
            <div class="col-sm-4 mt-4">
                <label for="" class="">Pasacalles Para Entidades Publicas<span
        ...
        <div class="row">
            <div class="col-sm-4" style="padding-left:10%;">
                <div class="entradas-de-texto-govco">
                    ...
                    <input class=form-control type="number" name="numero_de_elementos" id="numvehiculos"
                        placeholder="Ejemplo: Campo de texto" />
                </div>
            </div>
        ...
        <div class="row" style="padding-left:9.5% ;">
            ...
            <div class="col-sm-2">
                <div class="entradas-de-texto-govco">
                    ...
                    <input class=form-control type="string" name="Ancho" id="razon-social-id"
                        placeholder="Ejemplo: Campo de texto" />
                </div>
            </div>
            ...
            <div class="col-sm-2" style="padding-left:1%;">
                <div class="entradas-de-texto-govco">
                    ...
                    <input type="string" id="razon-social-id" name="Alto" placeholder="Ejemplo: Campo de texto" />
                </div>
            </div>
            ...
            <div class="col-sm-2" style="padding-left:1%;">
                <div class="entradas-de-texto-govco">
                    ...
                    <input class=form-control type="string" name="Area_total" id="razon-social-id"
                        placeholder="Ejemplo: Campo de texto" />
                </div>
            </div>
            ...
            <div class="col-sm-2" style="padding-left:1%;">
                <div class="entradas-de-texto-govco">
                    ...
                    <input class=form-control name="direccion" id="razon-social-id" placeholder="Ejemplo: Campo de texto"/>
                  </div>
            </div>
...
<div class="row" style="padding-left:10% ;">
    <div class="container-carga-de-archivo-govco">
        <div class="loader-carga-de-archivo-govco">
          <div class="all-input-carga-de-archivo-govco">
            <input type="file" name="Personeria_juridica" id="inputFile" class="input-carga-de-archivo-govco active" data-error="0" data-action="uploadFile" data-action-delete="deleteFile" multiple/>
