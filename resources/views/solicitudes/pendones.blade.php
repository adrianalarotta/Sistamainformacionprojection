...
<form action="{{ route('solicitudes.store') }}" enctype="multipart/form-data" method="POST">
        ...
        <div class="col-sm-4 mt-4" style="padding-left:10%">
            <label for="" class="">Modalidad de publicidad<span aria-required="true">*</span></label>
              <select class="form-control" id="modalidadpublicidad" onchange="modalidadpublicidad()">
                ...
                <option value="movil">Avisos y Pendones</option>
    ...
    <div class="col-sm-3 mt-4" >
      ...
      <select class="form-control" id="tiposolicitud" onchange="mostrartiposolicitud()">
    ...
    <div class="col-sm-4" style="padding-left:10%;" id="razon-social-div">
      ...
      <div class="col-sm-3" style="padding-left:3%;" id="razon-social-div">
          <div class="entradas-de-texto-govco">
            ...
            <input type="date" id="razon-social-id" name="fecha_de_retiro" placeholder="Ejemplo: Campo de texto"/>
          </div>
        </div>
  </div>
  <div class="row" >
    <div class="col-sm-4" style="padding-left:10%;">
      ...
      <div class="col-sm-3" style="padding-left:3%;" id="numvehiculos">
        <div class="entradas-de-texto-govco">
          ...
          <input class=form-control type="number" name="numero_de_elementos" id="numvehiculos" placeholder="Ejemplo: Campo de texto"/>
        </div>
      </div>
  ...
  <div class="row" style="padding-left:9.5%;">
    <div class="col-sm-2">
        <div class="entradas-de-texto-govco">
            ...
            <input class="form-control" type="number" name="Ancho" id="Ancho" placeholder="Ejemplo: Campo de texto" oninput="calcularAreaTotal('Area_Total', 'Ancho', 'Alto')" />
        </div>
    </div>
    ...
    <div class="col-sm-2" style="padding-left:1%;">
        <div class="entradas-de-texto-govco">
            ...
            <input type="number" name="Alto" id="Alto" placeholder="Ejemplo: Campo de texto" oninput="calcularAreaTotal('Area_Total', 'Ancho', 'Alto')" />
        </div>
    </div>
...
<script>
    function calcularAreaTotal(areaId, anchoId, altoId) {
        const ancho = parseFloat(document.getElementById(anchoId).value);
        const alto = parseFloat(document.getElementById(altoId).value);
        const areaTotal = ancho * alto;
        document.getElementById(areaId).value = areaTotal.toFixed(2);
    }
</script>
