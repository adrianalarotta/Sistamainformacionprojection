...
<div class="row form-group mt-2" id = "datosPersona">
	...
	<div class="col-md-6 pl-1 pr-1 pt-3 Natural @if($Datos->PersonaTipDoc=='NIT') {{'d-none'}} @endif">
		...
		<input value="{{ $Datos->PersonaNombre }}" type="text" required
	...
	<div class="col-md-6 pl-1 pr-1 pt-3 Natural @if($Datos->PersonaTipDoc=='NIT') {{'d-none'}} @endif">
		...
		<input value="{{ $Datos->PersonaApe }}" type="text" required
	...
	<div class="col-md-6 pl-1 pr-1 pt-3">
		...
		<select class="form-control  @error('tipo_documento') is-invalid  required @enderror"
	...
	<div class="col-md-6 pl-1 pr-1 pt-3">
		<label for="email_responsable" class="form-label">Correo electrónico de notificación electronica * </label>
